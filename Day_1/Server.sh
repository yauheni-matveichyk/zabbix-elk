...
rpm -Uvh http://repo.zabbix.com/zabbix/3.0/rhel/7/x86_64/zabbix-release-3.0-1.el7.noarch.rpm
    yum install -y postgresql-server postgresql-contrib zabbix-agent zabbix-server-pgsql zabbix-web-pgsql zabbix-get zabbix-sender
    ...
    zcat /usr/share/doc/zabbix-server-pgsql-3.0.28/create.sql.gz | sudo -u zabbix psql zabbix
